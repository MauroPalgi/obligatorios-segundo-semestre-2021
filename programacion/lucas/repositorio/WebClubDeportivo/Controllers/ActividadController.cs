...
namespace WebClubDeportivo.Controllers
{
    public class ActividadController : Controller
    {
        ...
        public ActionResult ListarIngresos(string cedula, DateTime fechaInicio, DateTime fechaFinal)
        {
            if (Session["logeado"] != null)
            {
                ...
                List<Registro> unR = FabricaRepositorio.ObtenerRepositorioRegistro().FiltrarIngresos(cedula, fechaInicio, fechaFinal);//trae registro
