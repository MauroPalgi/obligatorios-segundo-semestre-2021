...
namespace ConsolePrueba.ServicioActividades {
    ...
    public interface IServicioActividades {
        ...
        ConsolePrueba.ServicioActividades.Actividad[] GetAll();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicioActividades/GetAll", ReplyAction="http://tempuri.org/IServicioActividades/GetAllResponse")]
        System.Threading.Tasks.Task<ConsolePrueba.ServicioActividades.Actividad[]> GetAllAsync();
        ...
        ConsolePrueba.ServicioActividades.Actividad GetActividad(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicioActividades/GetActividad", ReplyAction="http://tempuri.org/IServicioActividades/GetActividadResponse")]
        System.Threading.Tasks.Task<ConsolePrueba.ServicioActividades.Actividad> GetActividadAsync(int id);
        ...
        ConsolePrueba.ServicioActividades.Actividad UpdateCupoActividad(int id, int cupo);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicioActividades/UpdateCupoActividad", ReplyAction="http://tempuri.org/IServicioActividades/UpdateCupoActividadResponse")]
        System.Threading.Tasks.Task<ConsolePrueba.ServicioActividades.Actividad> UpdateCupoActividadAsync(int id, int cupo);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServicioActividadesChannel : ConsolePrueba.ServicioActividades.IServicioActividades, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServicioActividadesClient : System.ServiceModel.ClientBase<ConsolePrueba.ServicioActividades.IServicioActividades>, ConsolePrueba.ServicioActividades.IServicioActividades {
        ...
        public ConsolePrueba.ServicioActividades.Actividad[] GetAll() {
            return base.Channel.GetAll();
        }
        
        public System.Threading.Tasks.Task<ConsolePrueba.ServicioActividades.Actividad[]> GetAllAsync() {
            return base.Channel.GetAllAsync();
        }
        
        public ConsolePrueba.ServicioActividades.Actividad GetActividad(int id) {
            return base.Channel.GetActividad(id);
        }
        
        public System.Threading.Tasks.Task<ConsolePrueba.ServicioActividades.Actividad> GetActividadAsync(int id) {
            return base.Channel.GetActividadAsync(id);
        }
        
        public ConsolePrueba.ServicioActividades.Actividad UpdateCupoActividad(int id, int cupo) {
            return base.Channel.UpdateCupoActividad(id, cupo);
        }
        
        public System.Threading.Tasks.Task<ConsolePrueba.ServicioActividades.Actividad> UpdateCupoActividadAsync(int id, int cupo) {
