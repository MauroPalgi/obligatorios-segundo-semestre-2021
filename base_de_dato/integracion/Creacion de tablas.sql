...
add constraint fk_idEstacion foreign key(idEstacion) references ESTACION(idEstacion);

/*TABLA LINEA_ESTACION*/
Create Table LINEA_ESTACION(idLinea numeric(2) not null, 
                            idEstacion numeric(5) not null)
alter table LINEA_ESTACION
add constraint pk_LINEA_ESTACION primary key(idTren, idEstacion, idLinea);
add constraint fk_idLinea foreign key(idLinea) references LINEA(idLinea);
add constraint fk_idEstacion foreign key(idEstacion) references ESTACION(idEstacion);
...
add constraint pk_ES_INICIO primary key(idTren, idEstacion, idLinea);
add constraint fk_idLinea foreign key(idLinea) references LINEA(idLinea);
add constraint fk_idEstacion foreign key(idEstacion) references ESTACION(idEstacion);
...
add constraint pk_ES_FINAL primary key(idTren, idEstacion, idLinea);
add constraint fk_idLinea foreign key(idLinea) references LINEA(idLinea);
add constraint fk_idEstacion foreign key(idEstacion) references ESTACION(idEstacion)
